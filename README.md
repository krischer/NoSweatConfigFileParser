...
## Features
The NoSweatConfigFileParser is configured completely via two files. The first file, which from now on will be called the *default config file*, specifies the type, the key name and the default value of every configuration option in the form
